...
CFLAGS :=  -DSTM32F30X -DUSE_STM32303C_EVAL -MD -DUSE_STDPERIPH_DRIVER -O2
CFLAGS += -mcpu=cortex-m3 -mthumb
CFLAGS += $(addprefix -I,$(inc-y))
LDFLAGS := -mcpu=cortex-m3 -mthumb -O2 -Tstm32f30x.ld -Wl,-cref,-u,Reset_Handler,-Map=$(OUTDIR)main.map,--gc-sections
AFLAGS := $(CFLAGS)
